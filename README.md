...
A token is what we use to identify the user by storing it in localStorage

- [ ] What steps can you take in your web apps to keep your data secure?
Make the token a requirement in order to view/use pages on your site

- [ ] Describe how web servers work.
Web servers store the code for a site which can be retrieved to view on your device by going to the url it is associated with
